...
'============================================================
' MONITOR FONDO 0 - Modulo unico (v8)  [v9.1: Contribucion YTD + QTD vs cierres de anio y trimestre]
...
Public Sub CrearEsqueleto()
    ...
    Hoja(SH_CON): Hoja(SH_VEN): Hoja(SH_CTR): Hoja(SH_CYTD)
...
Private Sub EncabezadoHistorico(ws As Worksheet)
    ws.Range("A1:AC1").Value = Array("FECHA", "DIAS", "VALCART MM", _
        ...
        "N INSTR", "N SIN MATCH", "SCORE LP", "SCORE CP")
    FormatoInstitucional ws.Range("A1:AC1")
End Sub
...
Private Sub ProcesarDia(ByVal fObs As Date, ByVal fFMS As Date, _
    ...
    EscribirHistorico fObs, diasTr, mtoTot, ytmF, ytmN, ytmB, ytmP, ytmD, _
                      ...
                      hhi, t5, t10, v30, v90, carryDia, nD, nSin, scLP, scCP
...
Private Sub EscribirHistorico(ByVal fObs As Date, ByVal diasTr As Double, _
    ...
    ByVal scLP As Double, ByVal scCP As Double)
    ...
    uf = UltFila(ws)
    If uf > 2 Then
        ws.Range("A2:AC" & uf).Sort Key1:=ws.Range("A2"), Order1:=xlAscending, Header:=xlNo
    End If
...
Private Function GuardarCopiaDia(ByVal fObs As Date) As String
    ...
    ThisWorkbook.Sheets(Array(SH_CART, SH_YLD, SH_CAL, SH_CON, SH_VEN, SH_CTR, SH_CYTD)).Copy
